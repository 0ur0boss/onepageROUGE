...
// const img = document.getElementById('oeuvre2')
...
function prefilter2(){
	...
	// oeuvre2.src = "img/tableau1.jpg";

	oeuvre2 = document.getElementById('oeuvre2');
	...
	width = oeuvre2.width;
	height = oeuvre2.height;
	canvas.width = width;
	canvas.height = height;

	// recopie l'image dans le canevas
	context.drawImage(oeuvre2, 0, 0, width, height);

	
	// extrait le tableau de pixels du canevas
	imgd = context.getImageData(0, 0, oeuvre2.width, oeuvre2.height);
...
function postfilter2(){
	...
	oeuvre2.setAttribute('src', data2);
}	
